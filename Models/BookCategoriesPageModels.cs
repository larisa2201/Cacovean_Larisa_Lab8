...
namespace Cacovean_Larisa_Lab8.Models
{
    public class BookCategoriesPageModels: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cacovean_Larisa_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cacovean_Larisa_Lab8Context context,
